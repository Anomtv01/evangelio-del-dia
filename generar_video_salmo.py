...
# Las ilustraciones de salmos pueden estar en assets/, en la raíz del repo,
# o en fotos_salmos/. Se buscan en todas por si quedaron repartidas.
...
def buscar_ilustracion(num_cat):
    """Busca la ilustración del salmo en todas las carpetas posibles
    (assets/, raíz, etc.), probando .png y .jpg. Devuelve la ruta o None."""
    for carpeta in CARPETAS_ILUSTRACIONES:
        for ext in (".png", ".jpg"):
            ruta = os.path.join(carpeta, f"salmo_{num_cat}{ext}")

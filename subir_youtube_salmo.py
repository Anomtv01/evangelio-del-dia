# -*- coding: utf-8 -*-
"""
Sube el video del Salmo del Día a YouTube usando la YouTube Data API v3.
...
Uso:
    python subir_youtube_salmo.py output_salmo/salmo_2026-08-11.json
"""
...
def buscar_o_crear_playlist(youtube, nombre):
    ...
    body = {
        "snippet": {"title": nombre, "description": "El Salmo de cada día, con reflexión."},
...
def main():
    if len(sys.argv) < 2:
        print("Uso: python subir_youtube_salmo.py output_salmo/salmo_<fecha>.json")
        sys.exit(1)
